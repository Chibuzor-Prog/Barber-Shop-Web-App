...
const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Calls backend POST /auth/register — password is hashed server-side
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-[#2c1e17] via-[#3b2a21] to-[#1a120d]">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600 mt-2">Create your account to book appointments</p>
        </div>
        ...
        <div className="mt-10">
          ...
          <p className="mt-4 text-center text-sm text-gray-700">
            ...
            <Link to="/" className="font-semibold text-blue-600 hover:underline">Login here</Link>
          </p>
        </div>
      </form>
    </div>
