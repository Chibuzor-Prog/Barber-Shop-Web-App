...
const OTPVerification: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4
      bg-gradient-to-br from-[#2c1e17] via-[#3b2a21] to-[#1a120d]">
      <form
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500 mt-3">
            ...
            <span className="font-medium text-gray-800">(use 123456 for testing)</span>
          </p>
        </div>
          ...
          {otp.map((digit, index) => (
            <input
              ...
              className={`w-12 h-14 sm:w-14 sm:h-16 text-center text-2xl font-bold rounded-xl
                border transition-all outline-none shadow-sm ${
                error
        ...
        <div className="mt-2">
          <button
            ...
            className="w-full rounded-xl bg-blue-600 py-3.5 font-semibold
              text-white shadow-sm hover:bg-blue-700 active:scale-[0.99] transition"
          >
            Verify Account
          </button>
